            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <!-- Current Password -->
                        <div class="mb-4">
                            <label for="current_password" class="block text-sm font-medium text-gray-700">Password Saat Ini (diperlukan untuk mengubah password)</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-1 py-2 px-3 bg-gray-100 rounded-md">
                                {{ $user->role ? $user->role->name : 'Tidak ada role' }}
                            </div>
                        </div>
